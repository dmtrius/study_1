...
public class Catalan {
    private static final Map<Long, Double> facts = new HashMap<>();
    private static final Map<Long, Double> catsI = new HashMap<>();
    private static final Map<Long, Double> catsR1 = new HashMap<>();
    private static final Map<Long, Double> catsR2 = new HashMap<>();
